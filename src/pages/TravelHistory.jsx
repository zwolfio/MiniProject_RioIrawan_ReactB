...
import { getHistory, searchDestinasi, insertPlan,done } from "../config/apollo/gqlClient";
...
const TravelList = () => {
    ...
    const { data: dataPlan, loading, refetch } = useQuery(getHistory, {
        variables: {
            id_user: id
        }
    })
